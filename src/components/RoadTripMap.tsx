...
export default function RoadTripMap() {
  ...
  const handleRiddleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {showRiddle && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/90 backdrop-blur-sm z-50">
          <div className="bg-black px-8 py-8 rounded-lg border-2 border-red-500 shadow-[0_0_50px_rgba(255,0,0,0.5)] max-w-md w-full mx-4">
            <div className="text-2xl font-bold text-red-500 mb-2 tracking-wider font-mono">
              &gt; ACCESS_CHALLENGE
            </div>
            <p className="text-xs text-red-400 mb-6 font-mono">
              Solve the riddle to access the waitlist
            </p>
