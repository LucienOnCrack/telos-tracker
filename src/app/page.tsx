    ...
    <div className="min-h-screen bg-black text-red-400 font-mono p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="border-4 border-red-500 bg-black p-4 md:p-8 shadow-[0_0_50px_rgba(255,0,0,0.3)]">
          <div className="border-2 border-red-500 bg-red-500 text-black text-center py-3 mb-8">
          ...
          <div className="space-y-8">
            <div>
              <div className="text-red-500 text-sm mb-3 tracking-wider">
            ...
            <div>
              ...
              <div className="pl-4 space-y-2 text-xs md:text-sm">
            ...
            <div>
              ...
              <div className="pl-4 flex flex-wrap gap-8 items-center">
                <a
                  href="https://vice.com"
                  target="_blank"
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 md:gap-3">
                    <div className="flex flex-col items-center min-w-3 md:min-w-4">
                      ...
                      <div className="w-0.5 h-10 md:h-12 bg-red-500/50"></div>
                    </div>
          ...
          <div className="border-2 border-red-500 bg-red-500 text-black text-center py-2 mt-10">
            <div className="text-xs md:text-sm font-bold tracking-widest">
              TOP SECRET // SPECIAL ACCESS REQUIRED
            </div>
          </div>

          <div className="mt-6 text-xs text-red-500/50 flex flex-col md:flex-row justify-between gap-2 text-center md:text-left">
            <div>DOC_REV: 1.0</div>
